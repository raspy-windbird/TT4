...
const update = {
	...
	rf:function(){
		document.getElementById('a').textContent = update.dec2bin(register.rA);
		document.getElementById('b').textContent = update.dec2bin(register.rB);
		document.getElementById('c').textContent = update.dec2bin(register.fC);
	},
	count:function(){
		document.getElementById('nowcount').textContent = update.dec2bin(counter.count);
	},
	dec2bin:function(f){
		const num = f.toString(2);
